 ...
 * Test categories
 */
export type ConformanceCategory = 'schema' | 'context' | 'profile' | 'agent' | 'rules' | 'permissions' | 'merge' | 'discovery' | 'cli';
/**
 * Test result
 */
 ...
 */
export type ConformanceLevel = 'full' | 'high' | 'basic' | 'partial' | 'none';
